    ...
    with sync_playwright() as p:
       ...
       #1. Transaction Ref ID
        ...
        page.wait_for_timeout(2000)
         ...
         #FILTER RULE FOR WP
        page.get_by_role("link", name="Filter Rules").click()
        page.get_by_role("button", name="Add Filter").click()
        page.get_by_text("Please Select").click()
        page.get_by_text("Something is equal to").click()
        page.get_by_text("Select Value Type").first.click()
        page.get_by_text("A Field", exact=True).click()
        page.locator("div").filter(has_text=re.compile(r"^Please Select a Field$")).nth(3).click()
        ...
        page.get_by_role("option", name="A Text").click()
        page.get_by_text("Click to edit").click()
        page.get_by_role("textbox", name="Enter text").fill("REFUSED")
        page.get_by_text("or", exact=True).click()
        page.get_by_text("or", exact=True).click()
        page.locator("div").filter(has_text=re.compile(r"^Please Select$")).nth(2).click()
        page.get_by_text("Something is equal to").click()
        page.get_by_text("Select Value Type").first.click()
        page.get_by_text("A Field", exact=True).click()
        page.locator("div").filter(has_text=re.compile(r"^Please Select a Field$")).nth(3).click()
        ...
        page.get_by_text("A Text").click()
        page.get_by_text("Click to edit").click()
        page.get_by_role("textbox", name="Enter text").fill("CAPTURED")
        page.get_by_text("or", exact=True).click()
        page.get_by_text("or", exact=True).click()
        page.locator("div").filter(has_text=re.compile(r"^Please Select$")).nth(2).click()
        page.get_by_text("Something is equal to").click()
        ...
        page.get_by_text("A Text").click()
        page.get_by_text("Click to edit").click()
        page.get_by_role("textbox", name="Enter text").fill("CANCELLED")
        page.locator(".anticon.anticon-check > svg").click()
        page.wait_for_timeout(2000)
        ...
        page.get_by_role("link", name="Rules & Rule Sets").click()
        page.get_by_role("row", name="TRANSACTION REF ID TEXT No").locator("center").click()
        page.get_by_role("button", name="Apply").click()
        page.get_by_role("button").nth(2).click()
        page.get_by_role("row", name="AMOUNT AMOUNT No Rules plus-").locator("center").click()
        page.get_by_role("button", name="Absolute Value").click()
        page.wait_for_timeout(2000)
        page.get_by_role("button", name="Apply").click()
        page.get_by_role("button").nth(2).click()
